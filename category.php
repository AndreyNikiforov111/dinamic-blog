...
$limit = 5;
$offset = $limit * ($page - 1);
$total_pages = round(countRow('posts', $_GET['id_category']) / $limit, 0);
$category = selectOne('topics', ['id' => $_GET['id_category']]);
$post = selectAllandUser('posts', 'users',  $_GET['id_category'], $limit, $offset);
                        ...
                        <div class="post row" style="display: flex; padding: 7.5px; align-items: center">
                            ...
                            <div class="post_text col-12 col-md-8">
                                ...
                                <div class="avtor">
                                    ...
                                    <i class="fa-solid fa-calendar"><span style="font-weight: normal"><?= mb_substr($post['created_date'], 0, 10, 'UTF-8');?></span></i>
                                </div>
                            </div>
                        </div>
                    <?php endforeach;?>
                    <!--НАВИГАЦИЯ-->
                    <?php include ('include/pagination-category.php')?>
                </div>
