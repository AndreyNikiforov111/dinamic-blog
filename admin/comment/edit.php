            ...
            <div class="row add-post"><!--подгужаем файлы во временную память нашего сервера-->
                ...
                <form action="edit.php" method="post">
                    <div class="col mb-2" id="marg">
                        <input type="text" name="email" value="<?=$email?>" readonly class="form-control" aria-label="Название статьи">
                    </div>

                    <div class="col">
                        <label for="content" class="form-label">Содержимое комментария</label>
                        <textarea class="form-control" name="content" id="editor" rows="3"><?=$comment?></textarea>
                    </div>
                    ...
                    <div class="col">
                        <button name="edit_comment" class="btn btn-primary mb-4" type="submit">Добавить запись</button>
                    </div>
                </form>
            </div>
        </div>
