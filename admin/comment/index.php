		...
		<div class="container">
            <?php include "../../include/sidebar-admin.php" ?>
				...
				<div class="posts col-9">
                    ...
                    <?php foreach ($commentsForAdmin as $key => $value): /*test($commentsForAdmin)*/;?>

					<div class="row post" >
						<div class="id col-1"><?=$key +1?></div>
						<div class="title col-3"><?= mb_substr($value['comment'], 0, 20, 'UTF-8');if(strlen($value['comment'])>20) echo '...'?></div>
						<div class="title col-2" style="overflow: hidden"><?= $value['email'] ?></div>
