...
<div class="wr">
    ...
    <div class="container">
            ...
            <div class="posts col-9 topics">
                <div class="button row">
                    <a href="create.php" class="col-2 btn btn-success">Создать категорию</a>
                    <a href="index.php" class="col-2 btn btn-warning">Управлять категориями</a>
                </div>
                ...
                <div class="row post">
                    ...
                    <div class="autor col-2"><a href="edit.php?id=<?=$value['id']?>">edit</a></div>
                                            <!--добавляется путь относительнотекущего методом GET-->
                    <div class="del col-2"><a href="?delete_id=<?=$value['id']?>">Delete</a></div>
                                         <!--сюда мы пишем GET пораметр      а здесь  -->
                </div>
                <?php endforeach;?>
            </div>
